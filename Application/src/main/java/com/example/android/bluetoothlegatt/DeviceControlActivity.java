...
public class DeviceControlActivity extends Activity {
   ...
   // private String mDeviceName;
    ...
    private EnvironmentDataCollector environmentDataCollector = new EnvironmentDataCollector();
    private final String LIST_NAME = "NAME";
    private final String LIST_UUID = "UUID";

    //Direction pad UI
    private ImageButton UP_ARROW;
    private ImageButton DOWN_ARROW;
    private ImageButton LEFT_ARROW;
    private ImageButton RIGHT_ARROW;
    private TextView accleration;
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // mDataField = (TextView) findViewById(R.id.data_value);
        accleration = (TextView) findViewById(R.id.accelerationInput);
        brightness = (TextView) findViewById(R.id.brightnessInput);
        forwardDistance = (TextView) findViewById(R.id.forwardDistanceInput);
        ...
        sensor2 = (TextView) findViewById(R.id.sensor2Input);
       ...
       // getActionBar().setTitle(mDeviceName);
        ...
        UP_ARROW.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                numberOfTerminalToMasterMessages++;
                mBluetoothLeService.sendMovementData(1);
            }
        });
        DOWN_ARROW.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                numberOfTerminalToMasterMessages++;
                mBluetoothLeService.sendMovementData(4);
            }
        });
        RIGHT_ARROW.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                numberOfTerminalToMasterMessages++;
                mBluetoothLeService.sendMovementData(2);
            }
        });
        LEFT_ARROW.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                numberOfTerminalToMasterMessages++;
                mBluetoothLeService.sendMovementData(3);
            }
        });
        }
            ...
            int sensor5Data = mBluetoothLeService.readSensor5Data();
                public void run() {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            brightness.setText("" + brightnessData);
                            accleration.setText("" + accelerationData);
                            forwardDistance.setText("" + forwardDistanceData);
                           // sensor1.setText("" + sensor1Data);
                            sensor2.setText("" + sensor2Data);
